...
Remember, everyone progresses at their own pace. Focus on enjoying the journey rather than comparing yourself to others!`,
    ...
    featuredImage: 'https://images.unsplash.com/photo-1574718397247-e7c2c3bd4ec6?w=800&h=400&fit=crop',
    authorId: 'admin-1',
    authorName: 'Sarah Martinez',
    authorAvatar: 'https://images.unsplash.com/photo-1494790108755-2616b612b786?w=150&h=150&fit=crop&crop=face',
    status: 'published',
    ...
    embeds: [
      {
        id: 'embed-2',
        type: 'image',
        url: 'https://images.unsplash.com/photo-1504609813442-a8924e83f76e?w=600&h=400&fit=crop',
